...
namespace BattleShipConversion
{
	...
	public class SeaGrid : ISeaGrid
	{
		...
		/// Show the tile view
		/// </summary>
		/// <param name="row">row coordinate of the tile</param>
		/// <param name="column">column coordiante of the tile</param>
		/// <returns></returns>
        override public TileView Item(int row, int column) {
			return _GameTiles[row, column].View;
		}
		...
		override public AttackResult HitTile(int row, int col)
		{
			try {
				//tile is already hit
